...
const Hero = () => {
  return (
    <div className='px-5 min-h-[840px] bg-hero bg-cover bg-bottom bg-no-repeat relative max-md:min-h-[600px]'>
      <img className='absolute top-[40%] -left-0 z-10 max-w-[322px] w-full max-lg:top-1/3 max-md:hidden' src="./assets/images/hero-left-layer.webp" alt="left vector" />
        <Header/>
        <div className='flex justify-center pt-[60px] items-center max-w-[1920px] mx-auto max-lg:flex-col gap-7 max-lg:pt-10 max-md:pt-7 max-sm:pt-5'>
            <div className='max-w-[680px] max-xl:max-w-[500px] text-center max-lg:w-full'>
                <h1 className='text-7xl text-white text-center font-bold max-xl:text-5xl max-md:text-5xl max-sm:text-3xl max-sm:leading-8'>Innovate, Automate, Accelerate </h1>
